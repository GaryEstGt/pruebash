...
if command -v snmpget –v 1 –c lab01 localhost dskPercent.1 > /dev/null 2>&1; then
...
if curl -s --head  --request GET "http://192.168.20.209/mymrtg/" | grep "200 OK" > /dev/null; then
